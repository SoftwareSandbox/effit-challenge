...
sealed class CompetitionCommands {
    ...
    data class AddChallenge(val id: CompetitionId, val challengeToAdd: ChallengeToAdd): Command<Competition>
}
...
typealias AddChallenge = CompetitionCommands.AddChallenge
