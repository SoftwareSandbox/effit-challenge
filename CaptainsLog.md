## 2023/09/16 - Rewrite in Ktor
Let's find out if Ktor + Kotlinx.Html DSL + Htmx is a fun way of writing web applications.

I bet initially I'll not be writing a lot of tests.

This project started off by just using IntelliJ's "new project" wizard, after which I got a working OAuth example based off the excellent ktor docs.
